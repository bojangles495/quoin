...
<p>
	...
	<ul>
		...
		<li>My vision of the solution would be that the later sprints would have a focus on design and functionility and the initial sprint be about the underlying components used in the later sprints.</li>
